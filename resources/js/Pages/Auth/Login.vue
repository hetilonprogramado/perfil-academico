...
import mask from '@assets/img/illustrations/auth-basic-mask-light.png';
...
<template>
        ...
        <body>
            ...
            <div class="authentication-wrapper authentication-basic container-p-y">
                ...
                <!-- /Login -->
                <img :src="tree3" alt="auth-tree" class="authentication-image-object-left d-none d-lg-block" />
                <img :src="mask" alt="triangle-bg" class="authentication-image d-none d-lg-block scaleX-n1-rtl" height="172" />
                <img :src="tree" alt="auth-tree" class="authentication-image-object-right d-none d-lg-block" />
